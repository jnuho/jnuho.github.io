---
layout: post
title: Simple Image recognizer
categories: [project]
tags: [kubernetes, deep learning, pytorch, microk8s]
fullview: false
comments: true
shortinfo: Kubernetes app (on 3-node) using deep learning binary classification (cat vs. non-cat image recognizer)
